...
description: "Interactive visualization of 80 entities and 176 relationships discovered across more than 1,200 FOIA documents from four Arkansas state agencies."
permalink: /network/
---
...
<section class="network-hero">
  <div class="container">
    <div class="network-hero-content">
      ...
      <p class="network-hero-sub">This graph maps <strong>80 entities</strong> and <strong>176 relationships</strong> extracted from more than 1,200 public records obtained through FOIA requests to four Arkansas state agencies. Click any node to inspect it. Use the filters to focus on what matters.</p>
    </div>
  </div>
</section>
