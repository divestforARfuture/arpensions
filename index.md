...
<section class="about-section">
  <div class="container-prose">
    ...
    <p>Divest for AR Future is a grassroots campaign committed to exposing and challenging the misuse of public funds, holding decision-makers accountable to their fiduciary duties, and building a broad-based movement to align Arkansas's investments with the values of transparency, justice, and the well-being of Arkansans.</p>
    <p>Our research has analyzed <strong>more than 1,000 public records</strong> obtained through FOIA requests to four Arkansas state agencies. What we've found raises serious questions about whether pension fund investments are being made based on sound financial analysis — or something else entirely.</p>
